...
about:
  template: jolla
  id: about-block
  image: "img/IMG_4246.jpg"
  links:
    - icon: twitter
      text: Twitter
      href: https://twitter.com/Scott_Oatley_
    - icon: github
      text: Github
      href: https://github.com/Scott0atley
    - icon: linkedin
      text: LinkedIn
      href: https://www.linkedin.com/in/scott-oatley-b87408157/
    - icon: envelope
      text: Email
      href: "mailto:mail.scottoatley59@gmail.com"  
---
...
On this website, you will find information on my research. 
Please feel free to [contact me](mailto:mail.scottoatley59@gmail.com) if you have any questions or would like to discuss potential projects.
